...
module CfnDsl
  module AWS
    module ServiceCatalog
      ...
      class PortfolioPrincipalAssociation < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for PrincipalARN
        def PrincipalARN(value)
          dsl_attribute(:PrincipalARN, value)
        end
        ...
        #   @param [String|JSONable] value
        #     The value to use for PrincipalType
  ...
  class CloudFormationTemplate
    ...
    def AWS_ServiceCatalog_PortfolioPrincipalAssociation(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::ServiceCatalog::PortfolioPrincipalAssociation, &block)
    end
  end
