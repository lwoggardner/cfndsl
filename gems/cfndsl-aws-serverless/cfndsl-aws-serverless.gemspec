...
require_relative 'lib/cfndsl_aws_serverless_version'
require_relative '../../gems/cfndsl-core/lib/cfndsl/version'

Gem::Specification.new do |s|
  s.name        = 'cfndsl-aws-serverless'
  s.version     = CfnDsl::Aws::Serverless::VERSION
  s.summary     = 'CfnDsl for AWS::Serverless'
  s.description = 'CfnDsl Resources for AWS::Serverless'
  s.authors     = ['cfndsl']
