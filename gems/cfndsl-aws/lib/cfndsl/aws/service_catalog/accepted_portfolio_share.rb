...
module CfnDsl
  module AWS
    module ServiceCatalog
      ...
      class AcceptedPortfolioShare < ResourceType
  ...
  class CloudFormationTemplate
    ...
    def AWS_ServiceCatalog_AcceptedPortfolioShare(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::ServiceCatalog::AcceptedPortfolioShare, &block)
    end
  end
