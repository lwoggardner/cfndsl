...
module CfnDsl
  module AWS
    module EC2
      ...
      class EIP < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for PublicIpv4Pool
        def PublicIpv4Pool(value)
          dsl_attribute(:PublicIpv4Pool, value)
        end
  ...
  class CloudFormationTemplate
    # @return [AWS::EC2::EIP]
    def AWS_EC2_EIP(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::EC2::EIP, &block)
    end
  end
