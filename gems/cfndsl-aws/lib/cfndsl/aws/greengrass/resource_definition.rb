...
module CfnDsl
  module AWS
    module Greengrass
      ...
      class ResourceDefinition < ResourceType
        ...
        # Property Definition ResourceDefinitionVersion
        ...
        #   @param [ResourceDefinitionVersion|JSONable] value
        #     The value to use for InitialVersion
        # @@overload InitialVersion(&block)
        #   Set :InitialVersion from block via instance eval of a new ResourceDefinitionVersion
        def InitialVersion(value = nil, **value_hash, &block)
          dsl_attribute(:InitialVersion, value, attr_class: ResourceDefinitionVersion, **value_hash, &block)
        end
      end
    end
  end
  ...
  class CloudFormationTemplate
    ...
    def AWS_Greengrass_ResourceDefinition(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::Greengrass::ResourceDefinition, &block)
    end
  end
