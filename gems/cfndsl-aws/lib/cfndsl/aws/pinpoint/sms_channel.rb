...
module CfnDsl
  module AWS
    module Pinpoint
      ...
      class SMSChannel < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for ShortCode
        def ShortCode(value)
          dsl_attribute(:ShortCode, value)
        end
  ...
  class CloudFormationTemplate
    ...
    def AWS_Pinpoint_SMSChannel(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::Pinpoint::SMSChannel, &block)
    end
  end
