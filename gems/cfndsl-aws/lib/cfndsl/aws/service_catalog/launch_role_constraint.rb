...
module CfnDsl
  module AWS
    module ServiceCatalog
      ...
      class LaunchRoleConstraint < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for LocalRoleName
        def LocalRoleName(value)
          dsl_attribute(:LocalRoleName, value)
        end
  ...
  class CloudFormationTemplate
    ...
    def AWS_ServiceCatalog_LaunchRoleConstraint(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::ServiceCatalog::LaunchRoleConstraint, &block)
    end
  end
