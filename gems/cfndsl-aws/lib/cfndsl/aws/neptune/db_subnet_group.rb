...
module CfnDsl
  module AWS
    module Neptune
      ...
      class DBSubnetGroup < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for DBSubnetGroupDescription
        def DBSubnetGroupDescription(value)
          dsl_attribute(:DBSubnetGroupDescription, value)
        end
  ...
  class CloudFormationTemplate
    ...
    def AWS_Neptune_DBSubnetGroup(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::Neptune::DBSubnetGroup, &block)
    end
  end
