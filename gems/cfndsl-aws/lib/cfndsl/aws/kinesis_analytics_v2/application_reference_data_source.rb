...
module CfnDsl
  ...
  class CloudFormationTemplate
    ...
    def AWS_KinesisAnalyticsV2_ApplicationReferenceDataSource(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::KinesisAnalyticsV2::ApplicationReferenceDataSource, &block)
    end
  end
