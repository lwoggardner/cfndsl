...
module CfnDsl
  module AWS
    module Pinpoint
      ...
      class BaiduChannel < ResourceType
  ...
  class CloudFormationTemplate
    ...
    def AWS_Pinpoint_BaiduChannel(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::Pinpoint::BaiduChannel, &block)
    end
  end
