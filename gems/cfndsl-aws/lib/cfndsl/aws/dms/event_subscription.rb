...
module CfnDsl
  module AWS
    module DMS
      ...
      class EventSubscription < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for SubscriptionName
        def SubscriptionName(value)
          dsl_attribute(:SubscriptionName, value)
        end
  ...
  class CloudFormationTemplate
    ...
    def AWS_DMS_EventSubscription(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::DMS::EventSubscription, &block)
    end
  end
