...
module CfnDsl
  module AWS
    module CloudFormation
      ...
      class Stack < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for TemplateURL
  ...
  class CloudFormationTemplate
    ...
    def AWS_CloudFormation_Stack(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::CloudFormation::Stack, &block)
    end
  end
