...
module CfnDsl
  module AWS
    module Redshift
      ...
      class ClusterSubnetGroup < ResourceType
  ...
  class CloudFormationTemplate
    ...
    def AWS_Redshift_ClusterSubnetGroup(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::Redshift::ClusterSubnetGroup, &block)
    end
  end
