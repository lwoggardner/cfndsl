...
module CfnDsl
  module AWS
    module EC2
      ...
      class SubnetCidrBlock < ResourceType
  ...
  class CloudFormationTemplate
    ...
    def AWS_EC2_SubnetCidrBlock(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::EC2::SubnetCidrBlock, &block)
    end
  end
