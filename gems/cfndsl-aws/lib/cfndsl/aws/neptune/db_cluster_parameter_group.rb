...
module CfnDsl
  module AWS
    module Neptune
      ...
      class DBClusterParameterGroup < ResourceType
  ...
  class CloudFormationTemplate
    ...
    def AWS_Neptune_DBClusterParameterGroup(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::Neptune::DBClusterParameterGroup, &block)
    end
  end
