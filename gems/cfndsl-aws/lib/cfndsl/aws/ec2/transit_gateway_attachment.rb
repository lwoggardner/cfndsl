...
module CfnDsl
  module AWS
    module EC2
      ...
      class TransitGatewayAttachment < ResourceType
  ...
  class CloudFormationTemplate
    ...
    def AWS_EC2_TransitGatewayAttachment(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::EC2::TransitGatewayAttachment, &block)
    end
  end
