...
module CfnDsl
  module AWS
    module ServiceCatalog
      ...
      class ResourceUpdateConstraint < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for TagUpdateOnProvisionedProduct
        def TagUpdateOnProvisionedProduct(value)
          dsl_attribute(:TagUpdateOnProvisionedProduct, value)
        end
  ...
  class CloudFormationTemplate
    ...
    def AWS_ServiceCatalog_ResourceUpdateConstraint(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::ServiceCatalog::ResourceUpdateConstraint, &block)
    end
  end
