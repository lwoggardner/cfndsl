...
module CfnDsl
  module AWS
    module ServiceCatalog
      ...
      class Portfolio < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for PortfolioName
        def PortfolioName(value)
          dsl_attribute(:PortfolioName, value)
        end
  ...
  class CloudFormationTemplate
    ...
    def AWS_ServiceCatalog_Portfolio(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::ServiceCatalog::Portfolio, &block)
    end
  end
