...
module CfnDsl
  module AWS
    module ServiceCatalog
      ...
      class PortfolioProductAssociation < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for SourcePortfolioId
        def SourcePortfolioId(value)
          dsl_attribute(:SourcePortfolioId, value)
        end
  ...
  class CloudFormationTemplate
    ...
    def AWS_ServiceCatalog_PortfolioProductAssociation(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::ServiceCatalog::PortfolioProductAssociation, &block)
    end
  end
