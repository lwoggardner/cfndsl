...
module CfnDsl
  module AWS
    module Greengrass
      ...
      class FunctionDefinition < ResourceType
        # Property Definition FunctionDefinitionVersion
        ...
        #   @param [FunctionDefinitionVersion|JSONable] value
        #     The value to use for InitialVersion
        # @@overload InitialVersion(&block)
        #   Set :InitialVersion from block via instance eval of a new FunctionDefinitionVersion
        def InitialVersion(value = nil, **value_hash, &block)
          dsl_attribute(:InitialVersion, value, attr_class: FunctionDefinitionVersion, **value_hash, &block)
        end
  ...
  class CloudFormationTemplate
    ...
    def AWS_Greengrass_FunctionDefinition(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::Greengrass::FunctionDefinition, &block)
    end
  end
