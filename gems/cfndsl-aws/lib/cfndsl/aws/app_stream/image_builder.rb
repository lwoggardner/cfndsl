...
module CfnDsl
  module AWS
    module AppStream
      ...
      class ImageBuilder < ResourceType
        ...
        #   @param [String|JSONable] value
        #     The value to use for AppstreamAgentVersion
        def AppstreamAgentVersion(value)
          dsl_attribute(:AppstreamAgentVersion, value)
        end
        ...
        #   @param [String|JSONable] value
        #     The value to use for StreamingUrl
        def StreamingUrl(value)
          dsl_attribute(:StreamingUrl, value)
        end
  ...
  class CloudFormationTemplate
    ...
    def AWS_AppStream_ImageBuilder(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::AppStream::ImageBuilder, &block)
    end
  end
