...
module CfnDsl
  module AWS
    module EC2
      ...
      class TransitGatewayRouteTable < ResourceType
  ...
  class CloudFormationTemplate
    ...
    def AWS_EC2_TransitGatewayRouteTable(logical_id, value = nil, &block)
      Resource(logical_id, value, attr_class: AWS::EC2::TransitGatewayRouteTable, &block)
    end
  end
